...
import com.sumscope.cdhplus.realtime.quickfixj.callback.TradeCallback;
...
public class TradeReceiver {
    ...
    @Autowired
    private TradeCallback trade_callback;
    ...
    public void start(){
        ...
        try {
            receiver = ReceiverFactory.newReceiver(createOptions,trade_callback);
        } catch (Exception e) {
